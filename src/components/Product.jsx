            ...
            <div className="product flex flex-col items-center gap-7 md:flex-row md:items-start">
                ...
                <div className="product-texts flex flex-col gap-5 mx-26 pl-5 md:pl-0 w-[21.75rem] h-[29.438rem] md:w-full md:h-full">
                    ...
                    <div className="ratings flex gap-2.5">
                        ...
                        <h6 className="text-[#737373] text-sm font-bold leading-6">10 Reviews</h6>
                    </div>
                    <h3 className="text-2xl font-bold leading-8 text-[#252B42]">$1,139.33</h3>
                    ...
                    <p className="text-[#858585] text-sm leading-5 my-2.5">Met minim Mollie non desert Alamo est sit cliquey dolor do met sent. RELIT official consequent door ENIM RELIT Mollie. Excitation venial consequent sent nostrum met.</p>
