...
export default function ShopCategory({category}) {
    return (
        <section className="shop-category flex flex-col items-center">
            <div className="category w-[20.75rem] h-[18.75rem] md:w-[12.813rem] md:h-[13.938rem] bg-center bg-cover flex flex-col items-center justify-center text-white" style={{backgroundImage: `url(${category?.img})`}}>
